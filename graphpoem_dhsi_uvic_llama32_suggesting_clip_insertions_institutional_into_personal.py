...
OUTPUT_JSON = pathlib.Path("llama3.2_graphpoem_institutional_into_personal_clip_ordering.json")
...
1. **Propose an ordering** of the 10 clips (`r0 … r9`) that, when inserted
   into the source video, creates a *coherent artistic pattern*.
   The pattern should reflect a personal artistic journey that gradually
   moves toward a “creativity‑embedding” and personal‑development‑conducive
   organization.
...
# Output 
# ['shot_0502_time_3809s.mp4', "shot_0665_time_5628s.mp4", "shot_0441_time_4099s.mp4", "shot_0222_time_1590s.mp4", "shot_0788_time_6806s.mp4", "shot_0568_time_4339s.mp4", "shot_0371_time_3458s.mp4", "shot_0635_time_4843s.mp4", "shot_1168_time_7596s.mp4", "shot_0682_time_5321s.mp4"]
# from folder "place_flagey_graphpoem_dhsi_extracted_clips"